          ...
          <b-form @submit.prevent="submit">
            <b-form-group label="Name">
              <b-form-input
                ...
                required
              ></b-form-input>
              <div class="error" v-if="!$v.form.name.required && $v.form.name.$anyDirty">
                Field is required
              </div>
            </b-form-group>
            ...
            <b-form-group label="Email">
              <b-form-input
                ...
                type="email"
              ></b-form-input>
              <div class="error" v-if="!$v.form.email.email && $v.form.email.$anyDirty">
            ...
            <b-form-group label="Age">
              <b-form-input
                ...
                required
              ></b-form-input>
              <div class="error" v-if="!$v.form.age.required && $v.form.age.$anyDirty">
                Age is required
              </div>
